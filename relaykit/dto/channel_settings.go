...
type ChannelSettings struct {
	...
	ZstdRequestCompressionEnabled bool   `json:"zstd_request_compression_enabled,omitempty"`
...
type ChannelOtherSettings struct {
	...
	ForceIncludeObfuscation               *bool                 `json:"force_include_obfuscation,omitempty"`  // 强制设置 Responses SSE stream_options.include_obfuscation；nil 表示不干预
