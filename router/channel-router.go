...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/:id/codex/rate-limit-reset-credits", permission: authz.ChannelRead, handler: controller.GetCodexChannelRateLimitResetCredits},
	{method: http.MethodPost, path: "/:id/codex/rate-limit-reset-credits/consume", permission: authz.ChannelOperate, handler: controller.ConsumeCodexChannelRateLimitResetCredit},
