...
const compareNumber = (current, latest) => {
  if (current > latest) return 1;
  if (current < latest) return -1;
  return 0;
};

const comparePrereleaseIdentifier = (currentIdentifier, latestIdentifier) => {
...
const comparePrerelease = (currentPrerelease, latestPrerelease) => {
...
export const compareReleaseVersions = (currentVersion, latestVersion) => {
...
export const isUpToDateWithUpstream = (currentVersion, latestVersion) => {
