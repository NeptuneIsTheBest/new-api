...
describe('system release ordering', () => {
  test.each([
    ...
    ['v1.0.0-rc.37-fork.1', 'v1.0.0-rc.37', 0],
    ['v1.0.0-rc.37-fork.2', 'v1.0.0-rc.36', 1],
    ['v1.0.0-rc.36-fork.10', 'v1.0.0-rc.37', -1],
    ['v1.0.0-fork.1', 'v1.0.0', 0],
    ['v1.0.0-rc.19-i18nfix.2-fork.1', 'v1.0.0-rc.20', -1],
    ['v0.13.1-patch.10-fork.1', 'v0.13.2', -1],
    ['v1.0.0-rc.37-fork.01', 'v1.0.0-rc.37', null],
    ['v1.0.0-rc.37-fork.-1', 'v1.0.0-rc.37', null],
    ['dev-fork.1', 'v1.0.0', null],
    ['v1.0.0', 'v1.0.0', 0],
    ['v0.0.0', 'v1.0.0', null],
    ['dev', 'v1.0.0', null],
    ['', 'v1.0.0', null],
