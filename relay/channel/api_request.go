...
func applyUpstreamContentEncoding(req *http.Request, info *common.RelayInfo) {
	if req == nil || info == nil || info.UpstreamRequestContentEncoding == "" {
		return
	}
	req.Header.Set("Content-Encoding", info.UpstreamRequestContentEncoding)
}
